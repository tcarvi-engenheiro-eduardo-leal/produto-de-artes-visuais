...
1. Representação figurativa do mundo natural
2. Representação Simbólica de contextos da vida humana
3. Expressão Abstrata dos elementos artísticos

### 1. Representação figurativa do mundo natural
- Forma de expressão artística que busca representar/imitar a aparência "real" do mundo natural (objetos, pessoas ou situações).
...
- Características:
    - Condensa experiências em um único símbolo. Tal símbolo passa a representar a mensagem da obra de arte.
...
## Organização Visual nas Produções de Arte
